...
import { Shield, Map, Activity, AlertTriangle, LayoutDashboard } from 'lucide-react';
...
export default function Navbar() {
  ...
  const navItems = [
    ...
    { name: 'Safe Route', path: '/safe-route', icon: Activity },
    ...
    <>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 glass pb-safe z-50">
        <div className="flex items-center justify-around p-3">
          ...
          <Link
            to="/emergency"
            className="flex flex-col items-center gap-1 p-2 text-[#FF3B5C]"
          >
