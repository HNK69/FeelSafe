import { Activity, MapPin, Shield, TrendingUp, Users } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen px-4 md:px-8 py-8 max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Overview Stats */}
        <div className="glass p-6 rounded-3xl border border-gray-800 flex flex-col items-center justify-center text-center">
            ...
            <div>
              ...
              <div className="space-y-3">
                {COMMUNITY_ALERTS.map(alert => (
                  <div key={alert.id} className="p-3 bg-black/20 rounded-xl border border-gray-800 text-sm">
